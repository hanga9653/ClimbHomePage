    ...
    <!-- 게시물이 있을 때 컬렉션에 저장된 목록의 갯수만큼 반복한다. -->
       ...
       <tr align="center">
          ...
          <td align="left">
             ...
             <a href="../Main/view.do?idx=${ row.idx }">
                ${ row.title }</a>
          </td>
          <td>${ row.name }</td>
          ...
          <c:if test="${ not empty row.ofile }">
             <a href="../Main/download.do?ofile=${ row.ofile }&sfile=${ row.sfile}&idx=${ row.idx }">[Down]</a>
          </c:if>
          </td>
       </tr>
        </c:forEach>
    ...
    <table border="1" width="90%">
        <tr align="center">
            ...
            <td width="100"><button type="button"
                onclick="location.href='../Main/write.do';">글쓰기</button></td>
        </tr>
         <tr>
        	<td>
	        	<ul class="pagination">
