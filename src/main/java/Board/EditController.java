...
public class EditController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		req.getRequestDispatcher("/Main/Edit.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		if(fileName != null) {
			...
			FileUtil.deleteFile(req, "/UploadsDirectory", prevSfile);
		}
		else {
		...
		if(result == 1) {
			...
			resp.sendRedirect("../gallclimb/View.do?num=" + num);
		}
		/*
		 * else { JSFunction.alertLocation(resp, "비밀번호 검증을 다시 진행해주세요.",
		 * "../gallclimb/view.do?num="+ num); }
		 */
	}
}
